...
public class StudentManagerTest {
    ...
    public void testGenerateStudentDistribution_Success() {
        // Arrange
        Student student1 = new Student("Ella", "E1234");
        Student student2 = new Student("Manuel", "M5678");
        ...
        assertEquals(List.of("Ella (E1234)"), distribution.get("Group 1"));
        assertEquals(List.of("Manuel (M5678)"), distribution.get("Group 2"));
    }
